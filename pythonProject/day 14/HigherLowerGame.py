...
while(flag):
    ...
    def check_answer(guess,choice_1_followers, choice_2_followers):
        if choice_1_followers > choice_2_followers :
            return guess == "A"
        else:
            return guess == "B"

    choice_1_follower_count = choice_1["follower_count"]
    choice_2_follower_count = choice_2["follower_count"]
    iscorrect = check_answer(user_input,choice_1_follower_count,choice_2_follower_count)
